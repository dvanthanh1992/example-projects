...
dnf config-manager --enable ${vm_guest_os_distribution == "oracle-8" ? "ol8_baseos_latest" : "ol9_baseos_latest"}
dnf install -y ${vm_guest_os_distribution == "oracle-8" ? "oracle-epel-release-el8" : "oracle-epel-release-el9"}
dnf makecache
